...
//       .then(result => {
//         setIsLoading(false);
//         // Optionally update user profile with name and photoUrl here
...
const Register = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (!createUser) return; // prevent crash if context not ready
      ...
      >
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-700 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <input
                ...
                onChange={handleChange}
                placeholder="Your Name"
                className="w-full pl-3 py-3 bg-gray-700 border border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
                required
              />
            </div>
            ...
            <div className="flex items-center">
              ...
              <span className="text-gray-400 text-sm">
                I agree to the <a href="#" className="text-purple-400">Terms</a> & <a href="#" className="text-purple-400">Privacy Policy</a>
              </span>
            </div>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 bg-purple-600 hover:bg-purple-700 text-white rounded-lg font-bold"
            >
          ...
          <div className="mt-5 text-center text-gray-400">
            Already have an account?{' '}
            <Link to="/login" className="text-purple-400 font-bold">Sign in</Link>
          </div>
        </div>
      </div>
    </div>
